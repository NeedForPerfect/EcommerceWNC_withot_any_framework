        ...
        <div class="row">
            ...
            <div class="breadcrumbs">
                <ol class="breadcrumb">
                    ...
                    <li><a href="/admin/additionalyphoto/<?php echo $id; ?>">Управлять Фотографиями Данного Товара</a></li>
            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <p>META-KEYWORDS</p>
                        <textarea name="metakeywords"><?php echo $product['meta_keywords']; ?></textarea>
                        
                        <br/><br/>
                        
                        
                        <p>META-DESCRIPTION</p>
                        <textarea name="desc_meta"><?php echo $product['meta_description']; ?></textarea>
                        
                        <br/><br/>
                        
                        
                        <p>Friendly URL</p>
                        <input type="text" name="friendlyurl" placeholder="" value="<?php echo $product['friendly_url']; ?>">
